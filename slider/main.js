class IndexForSiblings{
    ...
    class Slider{
        ...
        this.move = this.move.bind(this);//  JS suele cambiar el valir de this, por eso es necesario reafirmarlo
        this.moveByButton = this.moveByButton.bind(this);
        this.slider = document.querySelector(selector);
        this.itemsCount = this.slider.querySelectorAll(".container > *").length;
        this.interval = null; //intervalo de tiempo
        this.contador = 0;
        ...
        //función para moverse a una dirección
        moveTo(index){
        let left = index * 100;
